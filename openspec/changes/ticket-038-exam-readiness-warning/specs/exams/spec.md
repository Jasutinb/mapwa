...
The game MUST show recommended readiness and current readiness before an exam attempt is committed.
...
- THEN the game warns that the attempt is risky and asks for confirmation

#### Scenario: Ready attempt clarity

- GIVEN the player meets or exceeds recommended readiness
- WHEN the player attempts the exam
- THEN the game still communicates the relevant readiness information or proceeds through a clear, intentional path
...
- THEN the existing exam attempt mechanics run normally

#### Scenario: Mobile parity

- GIVEN the readiness warning is open on mobile
- WHEN the player uses mobile confirmation or cancel controls
