...
class MobileControls:
    def __init__(self):
        ...
        self.joystick_center = pygame.math.Vector2(
            ...
            SCREEN_HEIGHT - self.bottom_hud_clearance - self.joystick_radius,
        )
    ...
    def create_rects(self):
        return {
            "action": pygame.Rect(
                SCREEN_WIDTH - self.margin - self.action_size,
                SCREEN_HEIGHT - self.margin - self.action_size,
                self.action_size,
                self.action_size,
            ),
        }
    ...
    def draw_joystick(self, screen):
        ...
        pygame.draw.circle(
            base_surface, (235, 235, 235, 190), center, self.joystick_radius, 2
        )
